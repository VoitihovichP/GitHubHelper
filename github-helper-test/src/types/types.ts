...
export type GetRepoResponse = Array<RepoItem | never>;
...
export type AddRepoInfoActionType = {
...
export type ReducerActionsTypes = AddUserInfoActionType | AddRepoInfoActionType;
